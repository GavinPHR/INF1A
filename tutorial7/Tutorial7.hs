...
-- You can use these wffs to test your implementation
...
-----------------------------------------------------------
-- Your task is to fill in the spots that are undefined --
-----------------------------------------------------------
...
prop_tseytin_equiv wff = undefined
...
---------------------------------------------------
-- Below are code from last week's tutorials 
